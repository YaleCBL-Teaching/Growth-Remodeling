"""
EXERCISE 0 — Biology & finite-strain mechanics
==============================================
...
HOW TO RUN
    uv run python exercises/ex00_biology_and_mechanics.py
...
def main() -> None:
    ...
    ax.set_title("Exercise 0: reference-config constituent laws  (dotted = Cauchy $\\sigma$)")
    ax.legend()
    fig.tight_layout()
