...
HOW TO RUN
    uv run python exercises/ex01_kinematic_growth.py
...
(and sweep a parameter in one line):
    ...
    uv run python run.py configs/ex01_kinematic_growth.yaml --sweep simulate.k_g=0.02,0.05,0.2
"""
