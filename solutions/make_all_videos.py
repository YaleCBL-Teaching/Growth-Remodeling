...
def video_kinematic():
    ...
    fig, anim = animate([r], HYPERTENSION, quantities=("sigma_norm", "mass", "lam"),
...
def video_cmm_turnover():
    ...
    fig, anim = animate([r], HYPERTENSION, quantities=("mass", "sigma_norm"),
...
def video_compare_hypertension():
    ...
    fig, anim = animate(results, HYPERTENSION, quantities=("sigma_norm", "mass"),
...
def video_compare_aneurysm():
    ...
    fig, anim = animate(results, ANEURYSM, quantities=("sigma_norm", "mass", "radius"),
...
def video_runaway():
    ...
    fig, anim = animate([r], severe, quantities=("sigma_norm", "radius"),
                        n_frames=190,
