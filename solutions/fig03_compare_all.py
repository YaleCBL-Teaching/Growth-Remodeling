...
docs/figures/fig03_compare_all.pdf: all four theories on the same axes, for two
...
Run:  uv run python solutions/fig03_compare_all.py
"""
...
FIG = "docs/figures/fig03_compare_all.pdf"
