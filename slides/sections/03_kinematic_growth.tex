...
% ============================================================================
\begin{frame}[t]{}
  \vfill\begin{center}{\Huge\color{YaleBlue} 4.\ \ Kinematic growth}\\[0.5em]
...
\begin{frame}[t]{}
  \begin{answerbox}{Kinematic growth}
    The stress plateau \emph{always} lands on the set-point --- stability is
    \textbf{imposed}, not predicted. The bar is unconditionally stable; the artery
    (Laplace $\lambda^2$) tips into runaway once \texttt{PRESSURE\_FACTOR} is large
    enough.
    \par\smallskip
    {\color{ABlue}\bfseries Learning.} Kinematic growth reaches the a-priori
    prescribed homeostasis, \emph{or} it is unstable --- nothing in between.
  \end{answerbox}
\end{frame}
