...
\begin{frame}[t]{Skip the Transient --- Solve for the End State}
  ...
  \giveneq{\underbrace{\Upsilon=1\Rightarrow\bar\sigma^*=\bar\sigma_h}_{\text{(A) growth balance}}
    \quad
    \underbrace{\bm{F}_n^{\alpha}=\text{const}\Rightarrow\sigma^{\alpha}=\sigma_h^{\alpha}}_{\text{(B) remodeling done}}
    \quad
...
\begin{frame}[t]{}
  ...
  \end{answerbox}
  \vspace{-0.3em}
  \bigfigw{fig04_equilibrated.pdf}{0.66\linewidth}{Your run: equilibrated end-state
