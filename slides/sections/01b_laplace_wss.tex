...
\begin{frame}[t]{Two Loads, Two Formulae, Two Adaptations}
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      ...
      \slboxeq{2.4em}{eq:laplace}{\sigma_\theta = \frac{Pa}{h}}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \slboxeq{2.4em}{eq:wss}{\tau_w = \frac{4\mu Q}{\pi\,a^3}}
...
\begin{frame}[t]{}
  ...
  \begin{answerbox}{Pressure adaptation}
    \begin{minipage}[c]{0.53\linewidth}
      ...
      \slboxeq{2.0em}{eq:ans:pressure}{h' = \left(\frac{P'}{P}\right) h = 2\,h.}
...
\begin{frame}[t]{}
  ...
  \begin{answerbox}{Flow adaptation}
    \begin{minipage}[c]{0.50\linewidth}
      $(a'/a)^3 = Q'/Q = 8$, so
      \slboxeq{2.0em}{eq:ans:flow}{a' = \left(\frac{Q'}{Q}\right)^{1/3} a = 2\,a.}
