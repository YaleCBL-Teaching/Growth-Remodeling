...
% ============================================================================
\begin{frame}[t]{}
  \vfill\begin{center}{\Huge\color{YaleBlue} Stability}\\[0.5em]
...
\begin{frame}[t]{Same tissue, two insults}
  ...
  \vfill
  {\footnotesize\color{BoxGray} You will map the stable / unstable boundary and move
  it by changing one tissue property in the exercise next.}
\end{frame}
