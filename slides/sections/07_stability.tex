...
% ============================================================================
\begin{frame}[t]{}
  \vfill\begin{center}{\Huge\color{YaleBlue} 8.\ \ Stability}\\[0.5em]
...
\begin{frame}[t]{}
  \begin{answerbox}{Stability map}
    ...
    away.
    \par\smallskip
    {\color{ABlue}\bfseries Learning.} The same existence test that defines the
    equilibrium boundary \emph{is} the stability criterion.
  \end{answerbox}
\end{frame}
